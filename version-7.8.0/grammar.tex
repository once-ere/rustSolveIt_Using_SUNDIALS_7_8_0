...
\textbf{What is still not expressible.} \kw{gear} couples two rotations
and \kw{rack} couples a rotation to a translation. What is missing is a
\textbf{prismatic} joint --- something confining a body to a line,
holding its orientation while freeing one translation. It is why a rack
here has no guide, and why a cam follower, a piston, and true rolling of
a wheel \emph{along the ground} are still out of reach. Its
position-level form would be two ordinary rows, needing none of the
wrapping cleverness \kw{gear} and \kw{rack} did: the awkward constraints
turned out to be the ones whose natural coordinate is an angle nobody
counted.
