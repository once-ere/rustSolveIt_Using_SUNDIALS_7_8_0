...
\textbf{What is still not expressible.} A \kw{gear} couples two
rotations. Nothing yet couples a rotation to a \emph{translation}, and
nothing confines a point to a line, so rack-and-pinion, sliders, cam
followers and a wheel rolling \emph{along the ground} remain out of
reach.
