...
Checking your build: \code{cargo test -{}-workspace} --- 592 tests should
pass.
...
\section{Eighteen worked examples}\label{sec:examples}
...
592 tests: 40 library, 19 collision, 9 conservation, 109 language, 92
