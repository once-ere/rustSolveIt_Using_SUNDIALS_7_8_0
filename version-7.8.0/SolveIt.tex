...
conserved to $6.4\times10^{-15}$; every centre stays on the pivot to
$7\times10^{-35}$\\
\code{cardan\_compass.html} & the same rings with a
\textbf{pendulous} bowl --- a ship's compass, seeking level &
periods $1.878587$ and $2.582727$ s against measured $1.883852$ and
$2.589688$\\
\end{tabular}
\end{center}
...
$0.6000004$. Grammar \S12.9 works the arithmetic through.
